...
![Docs Version Dropdown](./img/settings4.png)
...
![Docs Version Dropdown](./img/settings6.png)

Open the CSV File and file out the rows with all of your units

![Docs Version Dropdown](./img/settings7.png)
...
![Docs Version Dropdown](./img/settings10.png)
