...
There are 6 main features to the Chat Page
 ...
 To Use Simply Search for the tenant you would like to ask questions to in the search bar right underneath the navigational top bar.
 ...
 Once you have selected your tenant you may ask any question about the tenant using the ask a question bar at the bottom of the screen. 
 ...
 If a Tenant has multiple Units

 ## Property Chat
**Property Chat is not available on all Lease Link plans. Check your plan to see if Property Chat is included**
...
Property Chat Messages take longer to load. There is often a large amount of data to process, so the AI will take longer to respond. 

It will send a response message for every tenant. This allows you to get specific answers for each tenant.
...
There will be an AI message for each tenant that have sources.
...
## Sources
Sources are how you can know that the AI is responding with accurate answers. AI is a great tool that sometimes makes mistakes, but it will provide the page it got the answer for the question, and it will provide the chunk of text it took from the lease to answer your question.
...
If a source came from the same page number, it may not show up in the source list.


## Dates
**Terms and Rent is not available with all Lease Link Plans. Please Check your plan to see if Lease Extraction (Or Abstraction) is on your plan to see Terms and Rent**
...
## Previous Messages
If you would like to go to a previous chat with the same Tenant or Property, you can go to the bottom right of the screen and find the previous chat. Simply click on the Chat you would like to view to open that Chat!

![Docs Version Dropdown](./img/previousChats.png)

## Email Integration
Email Integration is currently in development. Once it is finished, it will pull data from contacts that you create [Create Person](./Person.md).
